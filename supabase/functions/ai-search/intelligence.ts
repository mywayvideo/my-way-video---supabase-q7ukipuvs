...
function buildSystemPrompt(context: any): string {
  ...
  const rules = [
    ...
    '',
    '- REGRA ABSOLUTA Nº1: Para CADA produto listado na resposta, você DEVE mostrar SUA imagem.',
    '- REGRA ABSOLUTA Nº2: Use <img src="URL" /> para a imagem de CADA produto.',
    '- REGRA ABSOLUTA Nº3: Coloque a imagem IMEDIATAMENTE ANTES do bloco de descrição do produto.',
    '- REGRA ABSOLUTA Nº4: EM COMPARAÇÕES (quando há 2+ produtos), TODOS os produtos comparados',
    '  DEVEM ter sua própria imagem — NUNCA mostre imagem de apenas um.',
    '',
    '- Use APENAS a URL que está depois de | image: no final da linha do produto.',
    '- NUNCA escreva a URL como texto. Mostre a imagem visualmente.',
    '- Não importa se é o primeiro ou o último produto — TODOS têm imagem.',
    '',
    'EXEMPLO CORRETO para comparação:',
    '',
    '<img src="URL_DA_IMAGEM_DO_PRODUTO_A" />',
    '**Produto A**',
    'Descrição do produto A...',
    '',
    '<img src="URL_DA_IMAGEM_DO_PRODUTO_B" />',
    '**Produto B**',
