...
- **Cabeçalhos Requeridos:**
  ...
  - `Authorization: Bearer <SUPABASE_USER_JWT>` *(JWT de usuário autenticado gerado pelo Supabase Auth)*
  - `apikey: <SUPABASE_ANON_KEY>` *(Chave pública anônima do Supabase)*
...
```
*A RPC executa busca híbrida instantânea (vetores + trigramas) sobre toda a tabela de 21.256 itens, abrangendo os Capítulos 84, 85, 90 e 94.*
